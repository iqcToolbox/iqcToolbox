...
methods
    ...
    addParameter(input_parser,...
                 'solver',...
                 'sdpt3',...
                 @(in) validateattributes(in, 'char', {'nonempty'}, mfilename))
    addParameter(input_parser,...
                 'verbose',...
                 true,...
                 @(in) validateattributes(in, 'logical', {'nonempty'}, mfilename))
    addParameter(input_parser,...
                 'debug',...
                 false,...
                 @(in) validateattributes(in, 'logical', {'nonempty'}, mfilename))
    ...
    addParameter(input_parser,...
                 ...
                 @(in) validateattributes(in, 'numeric', {'nonempty'}, mfilename))
    ...
    addParameter(input_parser,...
                 ...
                 @(in) validateattributes(in, 'logical', {'binary'}, mfilename))
